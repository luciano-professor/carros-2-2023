<aside class="fixed top-0 pb-3 px-4 h-screen border-r w-[15%] ml-0 flex flex-col justify-between">
    <nav>
        ...
        <div class="-mx-6 px-6 py-2 flex justify-center">
            <a href="/">
                <img src="{{ asset('images/car.png') }}" alt="Logo" class="w-28">
            </a>
        </div>
        ...
        <ul class="space-y-2 mt-6">
            ...
            {{-- Carros --}}
            <li>
                <a wire:navigate href="/carros"
                    class="px-2 py-3 flex items-center space-x-4 text-amber-500 hover:text-amber-700">
            ...
            {{-- Clientes --}}
            <li>
                <a href="#" class="px-2 py-3 flex items-center space-x-4 text-amber-500 hover:text-amber-700">
